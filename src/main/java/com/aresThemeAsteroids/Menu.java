...
public class Menu {
	...
	public void draw (Graphics g) {
		if (Game.WIDTH >= 1920) {
			...
			chooseShip = new Rectangle(Game.WIDTH / 3 - 107, 611, 850, 50);
			...
			g.drawString("Settings", chooseShip.x + 361, chooseShip.y + 40);
			g2d.draw(chooseShip);
			...
			chooseShip = new Rectangle(Game.WIDTH / 3 - 89, 515, 709, 50);
			...
			g.drawString("Settings", chooseShip.x + 300, chooseShip.y + 40);
			g2d.draw(chooseShip);
			...
			chooseShip = new Rectangle(Game.WIDTH / 3 - 76, 452, 605, 50);
			...
			g.drawString("Settings", chooseShip.x + 240, chooseShip.y + 40);
			g2d.draw(chooseShip);
